        ...
        <div className='row'>
          <div className={`col-4 ${styles.leftContainer}`}>
            ...
            <div className={styles.content}>
              <h5>Blanditiis Rerum Incidunt</h5>
            ...
            <div className={styles.bottom}>
              ...
              <div className={styles.prices}>
                <div className={styles.price_old}>$ 350.00</div>
                <div className={styles.price}>
                  <Button className={styles.priceBtn} Hover variant='small'>
                    $ 300.00
                  </Button>
                </div>
              </div>
          ...
          <div className={`col-8 ${styles.rightContainer}`}>SHOP DEALS</div>
        </div>
      </div>
    </div>
  );
